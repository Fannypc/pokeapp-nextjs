/*
  ...
  - You are about to drop the column `userId` on the `pokemons` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "pokemons" DROP CONSTRAINT "pokemons_userId_fkey";

-- AlterTable
ALTER TABLE "pokemons" DROP COLUMN "userId",
